...
import { User, Briefcase, Lock, Mail, ArrowRight, Eye, EyeOff } from 'lucide-react'
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen pt-16 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary-50 to-purple-50">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome Back</h1>
          <p className="text-gray-600">Sign in to your Mind Magna account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <form className="space-y-6">
            ...
            >
              <span>Sign In as {userType === 'client' ? 'Client' : 'Consultant'}</span>
