...
export default function Hero() {
  return (
    <section className="premium-hero relative isolate overflow-hidden px-4 pb-14 pt-16 text-white sm:px-6 sm:pb-18 lg:px-8">
      <div className="premium-hero__texture pointer-events-none absolute inset-0 z-0" />
      <div className="premium-hero__sheen pointer-events-none absolute inset-0 z-0" />
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-10 lg:min-h-[calc(100vh-4rem)] lg:grid-cols-[1.04fr_.96fr] lg:gap-8">
        ...
        <div className="hero-visual relative mx-auto w-full max-w-[360px] sm:max-w-[400px] lg:max-w-[430px]">
          ...
          <img src="/Banner_1.png" alt="Mind Magna Banner" className="hero-visual__image relative z-10 h-auto w-full mix-blend-screen" />
          ...
          <img src="/icon_4.png" alt="" aria-hidden="true" className="hero-floating-icon hero-floating-icon--four" />
