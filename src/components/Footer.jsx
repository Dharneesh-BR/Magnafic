        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://youtube.com/@magnafic?si=dqaQ-9Bud3gXvUCA" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center hover:opacity-80 transition-opacity">
              ...
              <a href="https://www.linkedin.com/company/magnafic/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center hover:opacity-80 transition-opacity">
